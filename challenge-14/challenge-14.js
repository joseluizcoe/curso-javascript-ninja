(function(){
  ...
  */
  var name = ['Jo', 'se','Lu','iz'];
  var nameP = name.reduce(function(acumulado, item){
  ...
  */
  var inversedName = name
    ...
    .split('')
    .reduceRight(function(acumulado, atual){
      return acumulado += atual;
    });
  ...
  */
  ...
  var result = numberObjects.filter( function(item) {
