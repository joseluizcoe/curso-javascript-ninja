...
let team = ['Brasil', 'China', 'Canada', 'Australia', 'Japao'];
...
function showTeamPosition(num){
    if(num > 0 && num <= team.length){
        return `O time que está em ${num}º lugar é o ${team[num -= 1]}`;
    } else if (num == 0 || num > team.length){
...
function showTeamPosition(){
    console.log(team.indexOf('Brasil'));
    console.log(team.indexOf('China'));
    console.log(team.indexOf('Canada'));
    console.log(team.indexOf('Japao'));
...
function convertToHex(color){
    switch(color){
        ...
        case 'pink':
            ...
            break;
        default:
            return `Não temos o equivalente hexadecimal para a ${color}.`;
    }
}
